# AGENDA Y CALENDARIO DE SEGUIMIENTO CRM
Registro de eventos, llamadas, recordatorios y plazos de descalificación de cuentas.
...
### Esta Semana (Antes del Zoom con Bobby)
*   **PREPARACIÓN ZOOM BOBBY — CHECKLIST:**
    - [ ] Correr PageSpeed Insights en el sitio Wix de Blueberry Blessings.
    - [ ] Análisis de la página de Facebook de Blueberry Blessings.
    - [ ] Mockup rápido de landing page moderna para venta de arándanos.
    - [ ] Análisis de competencia: otras granjas de arándanos en BC (Instagram/Facebook/Google Maps).
    - [ ] Propuesta de precio clara: Setup Fee ($2,500) + % Comisión sobre ventas generadas desde el sitio.

### Jueves 2 de Julio de 2026
*   **Carlos IT:** Fecha alternativa de seguimiento por WhatsApp si no se envió o no respondió el miércoles.

### Lunes 6 de Julio de 2026
*   **Blueberry Blessings (Bobby):** ~~Fecha Límite de Descalificación~~. **CANCELADA** — Bobby es ahora un cliente potencial activo de KASI. Zoom pendiente de agendar.
