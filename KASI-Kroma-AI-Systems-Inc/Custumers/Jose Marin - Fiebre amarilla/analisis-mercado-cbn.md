...
```mermaid
graph TD
    A[Nivel 3: Internacional - Millones de Latam/EE.UU. buscando emigrar] --> B(Nivel 2: Nacional Canadá - ~1.19 Millones de Hispanos)
    B --> C(Nivel 1: Local Vancouver/BC - ~51,500 a 66,000 Residentes)
```
